...
public class FlightMock {
    ...
    public FlightMock( String departureLocation, String arrivalLocation, int totalPrice,String departureTime,
            String departureDate, String arrivalTime,String duration,String flightNumber,int ticketsAvailable,
            String foodInfo,String airline,int maximumLuggageWeight,int numberOfPassengers,int id){  
    }
